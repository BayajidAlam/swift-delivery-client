...
const AddService = () => {
  ...
  const handleSubmit = event => {
    ...
    console.log(name,price,image,discription)
  ...
  return (
    <div className="border p-10 border-violet-300 my-5 rounded-lg w-1/2 mx-auto bg-slate-300">
      ...
      <form onSubmit={handleSubmit}>
       ...
       <button type="submit" className="bg-violet-300 my-3 text-3xl w-32 h-12 rounded-lg text-slate-600 font-bold">Submit</button>
       </div>
      </form>
      <Toaster/>
    </div>
