...
const Footer = () => {
  return (
    <footer className="footer footer-center p-8 bg-slate-300 text-base-content rounded">
    <div className="grid grid-flow-col gap-4">
      <Link className="link link-hover text-xl">About us</Link> 
      <Link className="link link-hover text-xl">Contact</Link> 
      <Link className="link link-hover text-xl">Jobs</Link> 
      <Link className="link link-hover text-xl">Complain</Link>
    </div> 
    <div>
      <div className="grid grid-flow-col gap-4">
